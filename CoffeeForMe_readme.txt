...
To initiate it you should:

1. Create application DataBase (only 1 time). Open python file coffeedb_initiate.py and execute it. DataBase is created.
2. Run web application. Open python file coffee_web and execute it. 
3. Open Chrome web browser. Enter adress: http://127.0.0.1:5000/ 
